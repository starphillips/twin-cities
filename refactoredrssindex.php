            ...
            <div class="w-full  mx-auto ">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div class="absolute -inset-0.5 bg-gradient-to-r from-transparent via-indigo-700 to-transparent border-2 rounded-lg blur relative group h-64">
                        ...
                        <section class="relative px-10 py-8 rounded-lg h-full flex flex-col justify-center">
                            ...
                            <form id="comment-form" class="flex flex-col gap-4">
                                <input type="text" id="username" placeholder="Your Name" required class="p-2 border-2 rounded-lg text-black">
                                <textarea id="comment" placeholder="Write a comment..." required class="p-2 border-2 rounded-lg text-black"></textarea>
                                <button type="submit" class="p-2 border-2 rounded-lg bg-indigo-700 text-white">Post Comment</button>
                            </form>
                        </section>
                    </div>
                    ...
                    <div class="absolute -inset-0.5 bg-gradient-to-r from-transparent via-indigo-700 to-transparent border-2 rounded-lg blur relative group h-64">
                        <div class="rounded-lg blur opacity-75"></div>
                        <section class="relative px-10 py-8 rounded-lg h-full flex flex-col justify-center">
                            <h3>Other User Comments</h3>

                            <input type="hidden" id="city-id" value="<?php echo $selectedCity; ?>">
                            <input type="text" id="comment-search" placeholder="Search comments..." class="p-2 border-2 rounded-lg mb-4 text-black">
                            
                            <div id="comment-list" class="overflow-y-auto h-full">Loading comments...</div>
                        </section>
                    </div>
...
<script>
    ...
    fetch(weatherAPI)
        ...
        .then(data => {
            ...
            let weatherContent = `<div class="forecast"><h4>5-Day Forecast:</h4>`;
